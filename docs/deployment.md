...
MONGODB_URI=mongodb+srv://user:pass@cluster.mongodb.net/kozen
...
# MongoDB Analytics
MONGODB_ANALYTICS_URI=mongodb+srv://user:pass@analytics.mongodb.net/kozen-analytics
```
  ...
  - name: kozen-engine
    properties:
      ...
      - name: LOG_LEVEL
        value: info
      - name: MONGODB_URI
        secureValue: mongodb+srv://user:pass@cluster.mongodb.net/kozen
      resources:
        requests:
          cpu: 0.5
          memoryInGB: 1
...
aws secretsmanager create-secret \
    ...
    --secret-string "mongodb+srv://user:pass@cluster.mongodb.net/kozen"

# Azure Key Vault
az keyvault secret set \
    --vault-name "kozen-vault" \
    --name "mongodb-uri" \
    --value "mongodb+srv://user:pass@cluster.mongodb.net/kozen"

# Kubernetes Secrets
kubectl create secret generic kozen-secrets \
    --from-literal=mongodb-uri="mongodb+srv://user:pass@cluster.mongodb.net/kozen" \
    --namespace=kozen-engine
```
